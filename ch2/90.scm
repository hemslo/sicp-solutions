...
; representations in our system. The situation is analogous to the
...
; lists and make the operations on term lists generic. Redesign the polynomial
; system to implement this generalization. This is a major effort, not a local
; change.

; add 'sparse and 'dense to table, and change all operations to generic
