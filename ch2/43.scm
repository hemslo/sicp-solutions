...
; (queen-cols) execute inside flatmap proc, so board-size times duplications,
; and every duplication has board-size recursions, so it is about
; T * board-size * board-size.
