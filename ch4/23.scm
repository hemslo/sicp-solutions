...
; case (typical of procedure bodies) where the sequence has just one expression.
; What work will the execution procedure produced by Alyssa’s program do? What
; about the execution procedure produced by the program in the text above? How
; do the two versions compare for a sequence with two expressions?

; in text, lopp is run in analyze.
; Alyssa's execute-sequence is in run time.
