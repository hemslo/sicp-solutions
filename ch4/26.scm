...
; details on both sides of the argument. Show how to implement unless as a
; derived expression (like cond or let), and give an example of a situation
; where it might be useful to have unless available as a procedure, rather than
; as a special form.
...
(define (unless-consequnce exp) (caddr exp))
