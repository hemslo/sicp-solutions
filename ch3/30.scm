...
; binary numbers. The inputs A1, A2, A3, ..., An and B1, B2, B3, ..., Bn are the
; two binary numbers to be added (each Ak and Bk is a 0 or a 1). The circuit
; generates S1, S2, S3, . . ., Sn, the n bits of the sum, and C , the carry from
; the addition. Write a proce- dure ripple-carry-adder that generates this
; circuit. The procedure should take as arguments three lists of n wires
; each—the Ak , the Bk , and the Sk —and also another wire C. The major drawback
