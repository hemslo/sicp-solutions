...
; square root of 1 modulo n,” that is, a num ber not equal to 1 or n − 1 whose
...
(define (conditional-square a n)
  (if (nontrivial-square-root? a n)
      0)
      (square a))
...
(define (expmod base exp m)
  (cond ((= exp 0) 1)
        ((even? exp)
         (remainder
          (conditional-square (expmod base (/ exp 2) m) m)
          m))
        (else
         (remainder
